...
class StatefulProcessorHandle:
    ...
    def getValueState(
        ...
        is_ttl_state = ttlDurationMs is not None # EDGE
        return ValueState(ValueStateClient(
            self._statefulProcessorApiClient, schema, is_ttl_state
        ), stateName)
    ...
    def getMapState(
        ...
        return MapState(
            MapStateClient(
                self._statefulProcessorApiClient, userKeySchema, valueSchema, is_ttl_state
            ),
            stateName,
        )
